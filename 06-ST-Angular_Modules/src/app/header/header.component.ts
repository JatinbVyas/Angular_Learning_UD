...
@Component({
  ...
  standalone: false, // This component is marked as standalone true, it means this will not treat as module type component. meaning it can be used without being declared in a module.
